...
_w['_sydConvConfig'] = {
  ...
  sydBalOpts: 'fluxsrtrunc,fluxtrunc',
  sydCrtOpts: 'fluxsrtrunc,fluxtrunc',
  sydPrcOpts: 'fluxsrtrunc,fluxtrunc',
  voiceSrOptions: '',
  sydBalExtraOpts: 'saharagenconv5',
  sydCrtExtraOpts: 'clgalileo,gencontentv3',
  sydPrcExtraOpts: 'clgalileo,gencontentv3',
  sydIDs: 'rankwritec,winmuid1tf,tnaenableux,adssqovr,tnaenable,ctrlconvcss,anssuplogprops,tempcacheread,temptacache,oldmmadesign,winshortmsgtf,0731ziv2,fluxpc0721t4,0518logos,724glmtclss0,277teditgnd,207hlthgrds0',
...
_w['_sydConvTranslation'] = {
  ...
  newUserGreet: '欢迎，我是必应。我利用 AI 的力量来协助你完成各种任务，如网络搜索、内容生成、有趣的活动和休闲谈话。你想先尝试什么?',
  newUserSugg1: '告诉我一个有趣的事实',
  newUserSugg2: '写一首诗',
  newUserSugg3: '玩游戏',
  repeatUserGreet: '欢迎回来。很高兴再次见到你。我今天能为你提供哪些帮助?',
  repeatUserSugg1: '创作歌曲',
  ...
  notificationMaxTurnsForInPrivateUsers: 'You\u0027ve reached the conversation limit for inPrivate mode. Open a non-inPrivate window to continue your chat',
  ...
  signInDescriptionInPrivate: 'Open a non-inPrivate window to have longer conversations or ask more questions',
